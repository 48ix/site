...
| :------------------- | :------------------ | :------------------ | ----------------------------------: |
| **rs1.phx.48ix.net** | `<Waiting on ARIN>` | `<Waiting on ARIN>` | [FRRouting](https://frrouting.org/) |
| **rs2.phx.48ix.net** | `<Waiting on ARIN>` | `<Waiting on ARIN>` | [FRRouting](https://frrouting.org/) |
