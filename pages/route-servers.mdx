...
<SEO title="Route Servers" description="48-IX Router Server Information" />
...
<Admonition
  type="warning"
  title="Forwarding"
  message="Don't try to point traffic towards the 48-IX route servers — IPv4 & IPv6 forwarding are disabled."
/>
...
| :---------------- | -----------: | -----------------: |
| rs1.phx.48-ix.net |  `192.0.2.1` | `2001:db8:48:1::1` |
| rs2.phx.48-ix.net |  `192.0.2.2` | `2001:db8:48:1::2` |
